                    ...
                    <div className="col-lg-2"></div>
                        <div className="card text-center">
                            ...
                            <div className="card-body">
                                <h5 className="card-title text-center">Informacion de la empresa</h5>
                                ...
                                <ResponsiveNavLink className="dropdown-item btn btn-primary" href={route('profile.edit')}>Editar</ResponsiveNavLink>
                                </a>
                            </div>
