                    ...
                    <div className="py-4">
                        <div className="d-flex justify-content-center align-items-center">
                            <div className="bg-white border rounded p-4">
                                <div className="text-dark font-weight-bold h4 mb-4">Welcome to Your Dashboard</div>
                                <p className="text-muted">You are logged in as {auth.user.name}.</p>
                                <p className="text-muted">Feel free to explore the features and manage your account.</p>
                            </div>
                        </div>
                    </div>
                    </>
